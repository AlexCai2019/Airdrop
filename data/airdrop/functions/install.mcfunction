...
execute unless entity @e[type=marker,tag=0,limit=1] align xz run summon marker ~.5 -64.0 ~.5 {Tags:["no","set","0","air_number"],CustomName:'"§c§l關閉"'}
execute unless entity @e[type=marker,tag=1,limit=1] align xz run summon marker ~.5 -64.0 ~.5 {Tags:["yes","set","1","air_number"],CustomName:'"§a§l開啟"'}
execute unless entity @e[type=marker,tag=2,limit=1] align xz run summon marker ~.5 -64.0 ~.5 {Tags:["2","air_number"]}
execute unless entity @e[type=marker,tag=3,limit=1] align xz run summon marker ~.5 -64.0 ~.5 {Tags:["3","air_number"]}
execute unless entity @e[type=marker,tag=4,limit=1] align xz run summon marker ~.5 -64.0 ~.5 {Tags:["4","air_number"]}
execute unless entity @e[type=marker,tag=5,limit=1] align xz run summon marker ~.5 -64.0 ~.5 {Tags:["5","air_number"]}
execute unless entity @e[type=marker,tag=6,limit=1] align xz run summon marker ~.5 -64.0 ~.5 {Tags:["6","air_number"]}
execute unless entity @e[type=marker,tag=7,limit=1] align xz run summon marker ~.5 -64.0 ~.5 {Tags:["7","air_number"]}
execute unless entity @e[type=marker,tag=8,limit=1] align xz run summon marker ~.5 -64.0 ~.5 {Tags:["8","air_number"]}
execute unless entity @e[type=marker,tag=9,limit=1] align xz run summon marker ~.5 -64.0 ~.5 {Tags:["9","air_number"]}
...
scoreboard objectives add air_borne dummy
...
scoreboard objectives add air_nausea dummy
scoreboard objectives add air_hunger dummy
scoreboard objectives add air_air air
...
scoreboard objectives add air_resurrection trigger
scoreboard objectives add air_has_jutsu_book dummy
...
scoreboard players set @e[type=marker,tag=1,limit=1] air_borne 1
scoreboard players set @e[type=marker,tag=0,limit=1] air_borne 0
...
scoreboard players set custom air_borne 1
