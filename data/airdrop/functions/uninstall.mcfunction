kill @e[type=marker,tag=air_number]
...
scoreboard objectives remove air_borne
...
scoreboard objectives remove air_nausea
scoreboard objectives remove air_hunger
scoreboard objectives remove air_air
...
scoreboard objectives remove air_resurrection
