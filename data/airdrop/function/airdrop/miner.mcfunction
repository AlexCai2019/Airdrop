...
[\
	...
	{Slot: 7, id: "torch"},\
	{Slot: 8, id: "torch"},\
	{Slot: 10, id: "blaze_spawn_egg", components: {item_name: "鑽地機", enchantment_glint_override: true, rarity: "uncommon", entity_data: {id: "blaze", Invulnerable: true, NoAI: true, NoGravity: true, CustomNameVisible: true, Silent: true, DeathLootTable: "airdrop:empty", Team: "air_drill", Tags: ["air_drill", "air_drill_initial"]}, custom_data: {gadget: "air_drill_egg"}}},\
	{Slot: 16, id: "blaze_spawn_egg", components: {item_name: "鑽地機", enchantment_glint_override: true, rarity: "uncommon", entity_data: {id: "blaze", Invulnerable: true, NoAI: true, NoGravity: true, CustomNameVisible: true, Silent: true, DeathLootTable: "airdrop:empty", Team: "air_drill", Tags: ["air_drill", "air_drill_initial"]}, custom_data: {gadget: "air_drill_egg"}}}\
]} destroy
