...
{\
	...
	{\
		...
		[\
			...
			{buy: {id: "iron_ingot", count: 6}, sell: {id: "lingering_potion", count: 4, components: {custom_name: {text: "燃燒瓶", italic: false}, potion_contents: {custom_color: 4144959}, max_stack_size: 64, tooltip_display: {hidden_components: ["potion_contents"]}, custom_model_data: {strings: ["molotov_cocktail"]}, custom_data: {projectile: "molotov_cocktail"}}}, maxUses: 1},\
			{buy: {id: "iron_ingot", count: 7}, sell: {id: "golden_apple", components: {item_name: {text: "金頭顱", color: "gold"}, item_model: "player_head", profile: {properties: {textures: ["eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNTY2YTg3NDYwMTczYWRmMDY3Y2IzNTZhZTIwMGQwMzA1MDQzNzhjNTUyZTM0MjhiNDc3NGM0YzExYTU5OWMyNCJ9fX0="]}}, food: {can_always_eat: true, nutrition: 8, saturation: 19.2F}, consumable: {consume_seconds: 0.0F, has_consume_particles: false, on_consume_effects: [{type: "apply_effects", effects: [{id: "absorption", duration: 2400, amplifier: 1}, {id: "regeneration", duration: 30, amplifier: 3}]}]}}}, maxUses: 1},\
			...
			{buy: {id: "iron_ingot", count: 9}, sell: {id: "snowball", components: {item_name: "鞭炮", lore: [{text: "神秘商人限定", color: "dark_aqua", italic: false}], enchantment_glint_override: true, rarity: "rare", custom_data: {projectile: "grenade"}, custom_model_data: {strings: ["bomb"]}}}, maxUses: 1},\
