...
{\
	...
	{\
		...
		[\
			...
			{buy: {id: "copper_ingot", count: 11}, sell: {id: "written_book", components: {lore: [[{text: "查驗並反制", color: "white", italic: false}, {translate: "effect.minecraft.invisibility"}, "的玩家"], {text: "神秘商人限定", color: "dark_aqua", italic: false}], written_book_content: {pages: [[{text: "選擇一名玩家進行查詢。\n\n如果該玩家有", font: "uniform"}, {translate: "effect.minecraft.invisibility"}, "效果，\n則解除他的所有效果，並扣除 ", {text: "5❤", color: "red"}, "。\n無論有沒有查到", {translate: "effect.minecraft.invisibility"}, "，查驗後此書消失。\n\n       ", {text: "[發動預言書]", click_event: {action: "run_command", command: "/trigger air_special_book set 3"}, hover_event: {action: "show_text", value: "點擊開始發動"}}]], title: "預言書", author: "Alex Cai"}, tooltip_display: {hidden_components: ["written_book_content"]}, custom_data: {book: "prophecy"}}}, maxUses: 1},\
