...
{\
	...
	{\
		...
		[\
			...
			{buy: {id: "iron_ingot", count: 5}, sell: {id: "egg", components: {custom_name: {text: "造橋蛋", italic: false}, enchantment_glint_override: true, rarity: "uncommon", custom_data: {projectile: "build_bridge"}}}, maxUses: 1},\
			...
			{buy: {id: "iron_ingot", count: 8}, sell: {id: "snowball", components: {custom_name: {text: "發射蜘蛛網", italic: false}, enchantment_glint_override: true, rarity: "uncommon", custom_data: {projectile: "throw_cobweb"}}}, maxUses: 1},\
			{buy: {id: "iron_ingot", count: 9}, sell: {id: "snowball", components: {custom_name: {text: "手榴彈", italic: false}, lore: [{text: "神秘商人限定", color: "dark_aqua", italic: false}], enchantment_glint_override: true, rarity: "rare", custom_data: {projectile: "grenade"}}}, maxUses: 1},\
	...
	equipment: {chest: {id: "netherite_chestplate", components: {enchantments: {thorns: 2, vanishing_curse: 1}}}},\
