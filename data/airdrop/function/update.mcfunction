...
execute if score update air_time matches 3 run tellraw @a ["<", {"text": "空投", "color": "aqua"}, "> 也歡迎大家到巴哈上給個GP喔(", {"text":"https://forum.gamer.com.tw/C.php?bsn=18673&snA=200820", "underlined": true, "clickEvent": {"action": "open_url", "value": "https://forum.gamer.com.tw/C.php?bsn=18673&snA=200820"}}, ")。"]
