...
[\
	...
	{nbt: "root.event.message", storage: "airdrop:data", interpret: true, click_event: {action: "run_command", command: "/function airdrop:set/event/on_off"}}, "\n",\
	...
	{nbt: "root.airdrop.message", storage: "airdrop:data", interpret: true, click_event: {action: "run_command", command: "/function airdrop:set/airdrop/on_off"}}, "\n",\
