#檢查身上有這本書
execute store success score #has_book air_special_book run clear @s written_book[custom_data~{book: "resurrection"}] 0
...
#清除一本書
clear @s written_book[custom_data~{book: "resurrection"}] 1
