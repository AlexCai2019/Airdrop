...
execute if items entity @s weapon warped_fungus_on_a_stick[custom_data~{special_block_wand: true}] at @s anchored eyes unless score @s air_wand matches 0 run function airdrop:game/effects/wand/release
