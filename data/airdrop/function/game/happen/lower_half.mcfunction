execute if score #event air_chance matches 8 run return run function airdrop:event/super_bounce
execute if score #event air_chance matches 9 run return run function airdrop:event/no_run
execute if score #event air_chance matches 10 run return run function airdrop:event/no_sneak
