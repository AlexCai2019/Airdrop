...
execute if data entity @s SelectedItem.components.minecraft:custom_data.special_block_wand at @s anchored eyes unless score @s air_wand matches 0 run function airdrop:game/warped_fungus_on_a_stick/wand
