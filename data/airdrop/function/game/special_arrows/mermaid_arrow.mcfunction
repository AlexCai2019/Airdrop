...
execute store result score song air_chance run random value 0..8
...
execute if score song air_chance matches 4 run tellraw @a ["[人魚之箭] <",{"selector":"@s"},"> 到最後 只能靠我的預感"]
execute if score song air_chance matches 5 run tellraw @a ["[人魚之箭] <",{"selector":"@s"},"> Never gonna give you up\n[人魚之箭] <",{"selector":"@s"},"> Never gonna let you down"]
execute if score song air_chance matches 6 run tellraw @a ["[人魚之箭] <",{"selector":"@s"},"> 總共104天的暑假又到來\n[人魚之箭] <",{"selector":"@s"},"> 離開學日子還很遙遠"]
execute if score song air_chance matches 7 run tellraw @a ["[人魚之箭] <",{"selector":"@s"},"> 這樣太危險 飛太遠"]
execute if score song air_chance matches 8 run tellraw @a ["[人魚之箭] <",{"selector":"@s"},"> Creeper? Aww man"]
