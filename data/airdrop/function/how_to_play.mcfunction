...
execute if score how_to_play air_time matches 4 run return run tellraw @a ["<", {"text": "遊玩教學", "color": "aqua"}, "> 踩在", {"translate": "block.minecraft.melon", "color": "#34791E"}, "、", {"translate": "block.minecraft.packed_ice", "color": "#7CA5F4"}, "、", {"translate": "block.minecraft.end_stone", "color": "#EEF6B4"}, "或", {"translate": "block.minecraft.magenta_glazed_terracotta", "color": "#DD68DA"}, "上會獲得特殊效果。"]
...
execute if score how_to_play air_time matches 13 run return run tellraw @a ["<", {"text": "遊玩教學", "color": "aqua"}, "> ", {"translate": "block.minecraft.magenta_glazed_terracotta", "color": "#DD68DA"}, " 特殊魔法：白狼王自爆，帶走自己和5格內最近的敵隊 (", {"text": "可以", "color": "green"}, "用", {"translate": "item.minecraft.shield"}, "擋、用", {"translate": "item.minecraft.totem_of_undying"}, "續命)"]
