...
execute if score how_to_play air_time matches 7 run return run tellraw @a ["<", {"text": "遊玩教學", "color": "aqua"}, "> 特殊魔法：範圍5格內，我方玩家獲得60秒", {"translate": "effect.minecraft.health_boost"}, "I效果"]
...
execute if score how_to_play air_time matches 9 run return run tellraw @a ["<", {"text": "遊玩教學", "color": "aqua"}, "> 特殊魔法：釋放消暑的魔法"]
